...
output_zip = os.path.join(
    DATA_FOLDER, 'MultiEmo_ Multilingual, Multilevel, Multidomain Sentiment Analysis Corpus of Consumer Reviews.zip')
...
os.remove(os.path.join(DATA_FOLDER, 'multiemo.7z'))

data_output_zip = os.path.join(DATA_FOLDER, 'multiemo.zip')
